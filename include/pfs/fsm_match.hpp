...
{
public:
    using match_traits_type = match_traits<Iterator, AtomicInt>;
    using atomic_type = typename match_traits_type::atomic_type;
    using char_type   = typename match_traits_type::char_type;
    using size_type   = typename match_traits_type::size_type;
    using iterator    = typename match_traits_type::iterator;
    using result_type = typename match_traits_type::result_type;
    using func_type   = typename match_traits_type::func_type;
